...
const routes: Routes = [
  ...
  {
    path: 'cardiologist',
    loadChildren: () => import('./pages/cardiologist/cardiologist.module').then( m => m.CardiologistPageModule)
  },
  {
    path: 'map',
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/appointment-schedule/appointment-schedule.module').then( m => m.AppointmentSchedulePageModule)
  },
  {
    path: 'lab-test',
  ...
  {
    path: 'search-test',
    loadChildren: () => import('./pages/search-test/search-test.module').then( m => m.SearchTestPageModule)
  },
  {
    path: 'medical-shop',
    loadChildren: () => import('./pages/medical-shop/medical-shop.module').then( m => m.MedicalShopPageModule)
  },
  {
    path: 'lab-map',
    loadChildren: () => import('./pages/lab-map/lab-map.module').then( m => m.LabMapPageModule)
  },
  {
    path: 'chat',
