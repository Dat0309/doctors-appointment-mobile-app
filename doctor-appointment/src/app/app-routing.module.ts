...
const routes: Routes = [
  ...
  },
  {
    path: 'find-doctor',
    loadChildren: () =>
      import('./find-doctor/find-doctor.module').then(
        (m) => m.FindDoctorPageModule
      ),
  },
  {
    path: 'cardiologist',
    loadChildren: () =>
      import('./cardiologist/cardiologist.module').then(
  ...
  },
  {
    path: 'doctor-info',
    loadChildren: () =>
      import('./doctor-info/doctor-info.module').then(
  ...
  },
  {
    path: 'my-appointment',
    loadChildren: () =>
      import('./my-appointment/my-appointment.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./appointment-schedule/appointment-schedule.module').then(
  ...
  },
  {
    path: 'lab-info',
    loadChildren: () =>
      import('./lab-info/lab-info.module').then((m) => m.LabInfoPageModule),
  },
  {
    path: 'search-test',
    loadChildren: () =>
      import('./search-test/search-test.module').then(
  ...
  },
  {
    path: 'medical-shop',
    loadChildren: () =>
      import('./medical-shop/medical-shop.module').then(
  ...
  },
  {
    path: 'lab-map',
    loadChildren: () =>
      import('./lab-map/lab-map.module').then((m) => m.LabMapPageModule),
  },
  {
    path: 'chat',
    loadChildren: () =>
